...
export const TAROT_FORTUNE: Record<number, CardFortune> = {
    0: {
        ...
        todayWarningAdvice: "자유가 방임이 될 때 발밑의 낭떠러지를 잊기 쉽습니다. 지금의 무계획은 용기가 아닌 위태로움일 수 있습니다. 이 흐름에서 무리한 행동은 큰 화를 부를 수 있으니, 모든 결정을 보류하고 철저히 관망하는 것이 현명합니다.",
    ...
    1: {
        ...
        todayWarningAdvice: "기술은 훌륭하나 진실함이 빠져있을 수 있습니다. 상대를 설득하는 힘이 자칫 기만으로 흐르지 않게 하세요. 이 흐름에서 무리한 행동은 큰 화를 부를 수 있으니, 모든 결정을 보류하고 철저히 관망하는 것이 현명합니다.",
    ...
    3: {
        ...
        todayWarningAdvice: "풍요에 대한 집착이 오히려 결핍을 부릅니다. 지나친 소유욕은 당신의 아름다움을 시들게 할 뿐입니다. 이 흐름에서 무리한 행동은 큰 화를 부를 수 있으니, 모든 결정을 보류하고 철저히 관망하는 것이 현명합니다.",
    ...
    5: {
        ...
        todayWarningAdvice: "전통이라는 이름의 감옥에 갇혀 있지는 않나요? 때로는 낡은 가르침보다 당신의 파격이 더 필요할 수 있습니다. 이 흐름에서 무리한 행동은 큰 화를 부를 수 있으니, 모든 결정을 보류하고 철저히 관망하는 것이 현명합니다.",
    ...
    6: {
        ...
        todayWarningAdvice: "순간의 이끌림이 평생의 속박이 될 수 있습니다. 지금의 조화가 환상인지 실제인지 차분히 들여다보세요. 이 흐름에서 무리한 행동은 큰 화를 부를 수 있으니, 모든 결정을 보류하고 철저히 관망하는 것이 현명합니다.",
        warning: "부조화, 유혹, 이별",
    ...
    7: {
        ...
        todayWarningAdvice: "속도보다 중요한 것은 방향입니다. 고삐 풀린 추진력은 결국 당신 자신을 집어삼킬 수도 있습니다. 이 흐름에서 무리한 행동은 큰 화를 부를 수 있으니, 모든 결정을 보류하고 철저히 관망하는 것이 현명합니다.",
        warning: "통제 상실, 폭주, 패배",
    ...
    9: {
        ...
        todayWarningAdvice: "고독이 고립으로 변하고 있습니다. 세상을 등지는 것이 해답은 아닙니다. 이제 문 밖으로 나갈 때입니다. 이 흐름에서 무리한 행동은 큰 화를 부를 수 있으니, 모든 결정을 보류하고 철저히 관망하는 것이 현명합니다.",
    ...
    10: {
        ...
        todayWarningAdvice: "상승이 있으면 하강도 있는 법입니다. 지금의 변화를 막으려 할수록 당신의 상황은 더 꼬여만 갈 것입니다. 이 흐름에서 무리한 행동은 큰 화를 부를 수 있으니, 모든 결정을 보류하고 철저히 관망하는 것이 현명합니다.",
    ...
    12: {
        todayAdvice: "움직이지 않는 것이 최선의 움직임입니다. 거꾸로 선 세상을 통해 평소 못 보던 가치를 발견하세요. 그러나 지금은 억지로 앞으로 나아가기보다 주변을 경계하고 멈춰 서야 할 때임을 명심하세요.",
    ...
    13: {
        todayAdvice: "과거의 낡은 껍데기를 벗어던져야 새 살이 돋아납니다. 끝은 화려한 부활의 전조입니다. 그러나 지금은 억지로 앞으로 나아가기보다 주변을 경계하고 멈춰 서야 할 때임을 명심하세요.",
        todayWarningAdvice: "이미 끝난 일에 미련을 두는 것은 고통을 연장할 뿐입니다. 썩은 가지를 잘라내지 못하면 나무 전체가 위태롭습니다. 하지만 이 위기를 반면교사로 삼아 주의를 기울여 나아간다면, 오히려 상황이 긍정적으로 반전될 수 있습니다.",
        warning: "과거 집착, 변화 거부",
    ...
    14: {
        ...
        todayWarningAdvice: "조화가 깨지고 불협화음이 시작됩니다. 극단을 오가는 당신의 태도가 주변을 불안하게 만들고 있습니다. 이 흐름에서 무리한 행동은 큰 화를 부를 수 있으니, 모든 결정을 보류하고 철저히 관망하는 것이 현명합니다.",
        warning: "불균형, 절제력 부족",
    ...
    15: {
        todayAdvice: "사슬의 열쇠는 당신의 손안에 있습니다. 달콤한 유혹 뒤의 진실을 냉정하게 바라보세요. 그러나 지금은 억지로 앞으로 나아가기보다 주변을 경계하고 멈춰 서야 할 때임을 명심하세요.",
        todayWarningAdvice: "유혹보다 무서운 것은 그것이 유혹임을 모르는 당신의 무지입니다. 속박을 즐기는 순간 자유는 영영 사라집니다. 하지만 이 위기를 반면교사로 삼아 주의를 기울여 나아간다면, 오히려 상황이 긍정적으로 반전될 수 있습니다.",
    ...
    16: {
        ...
        todayWarningAdvice: "붕괴를 막으려 애써봤자 소용없습니다. 진실이 폭로되는 순간을 겸허히 받아들이고 기초부터 다시 설계하세요. 이 흐름에서 무리한 행동은 큰 화를 부를 수 있으니, 모든 결정을 보류하고 철저히 관망하는 것이 현명합니다.",
        warning: "위기 모면, 재건 시작",
    ...
    17: {
        todayAdvice: "어둠이 깊을수록 별은 더 밝게 빛납니다. 지금 당신의 마음속에 떠오른 그 작은 희망을 믿으세요. 다만 다행히도 전체적인 흐름은 당신의 편이니, 주의하며 추진한다면 승산이 있습니다.",
        todayWarningAdvice: "희망이라는 이름의 환상에 빠져 현실을 보지 못하고 있습니다. 뜬구름 잡는 계획은 결국 당신을 공허하게 만듭니다. 이 흐름에서 무리한 행동은 큰 화를 부를 수 있으니, 모든 결정을 보류하고 철저히 관망하는 것이 현명합니다.",
        warning: "실망감, 헛된 희망",
    ...
    18: {
        todayAdvice: "안개가 자욱한 밤길입니다. 보이는 것 너머의 진실을 느끼세요. 지금은 직관이 당신의 지도입니다. 그러나 지금은 억지로 앞으로 나아가기보다 주변을 경계하고 멈춰 서야 할 때임을 명심하세요.",
    ...
    19: {
        ...
        todayWarningAdvice: "태양이 너무 밝으면 그림자도 짙어집니다. 지나친 자신감이 타인의 노력을 가리고 있지는 않은지 살피세요. 이 흐름에서 무리한 행동은 큰 화를 부를 수 있으니, 모든 결정을 보류하고 철저히 관망하는 것이 현명합니다.",
    ...
    20: {
        ...
        todayWarningAdvice: "외면해왔던 과거가 당신의 발목을 잡습니다. 뒤늦은 후회보다 지금의 책임을 지는 것이 더 중요합니다. 이 흐름에서 무리한 행동은 큰 화를 부를 수 있으니, 모든 결정을 보류하고 철저히 관망하는 것이 현명합니다.",
        warning: "기회 상실, 과거 발목",
    ...
    22: {
        ...
        todayWarningAdvice: "불씨만 지피고 정작 장작을 넣지 못하고 있네요. 시작은 거창하나 흐름이 금세 끊길 수 있습니다. 이 흐름에서 무리한 행동은 큰 화를 부를 수 있으니, 모든 결정을 보류하고 철저히 관망하는 것이 현명합니다.",
    ...
    23: {
        ...
        todayWarningAdvice: "준비가 길어지면 기회는 남의 손으로 넘어갑니다. 성벽 안의 안락함에 안주하여 시야를 닫고 있지는 않나요? 이 흐름에서 무리한 행동은 큰 화를 부를 수 있으니, 모든 결정을 보류하고 철저히 관망하는 것이 현명합니다.",
    ...
    24: {
        ...
        todayWarningAdvice: "자신만만했던 계획이 변수를 만납니다. 저 멀리 보이는 수평선이 당신이 생각한 그 풍경이 아닐 수도 있습니다. 이 흐름에서 무리한 행동은 큰 화를 부를 수 있으니, 모든 결정을 보류하고 철저히 관망하는 것이 현명합니다.",
    ...
    25: {
        ...
        todayWarningAdvice: "축제의 분위기 뒤로 긴장감이 흐릅니다. 겉으로는 평화로워 보이나 내부의 토대가 흔들리고 있음을 직시하세요. 이 흐름에서 무리한 행동은 큰 화를 부를 수 있으니, 모든 결정을 보류하고 철저히 관망하는 것이 현명합니다.",
    ...
    26: {
        todayAdvice: "사공이 많아 배가 산으로 가고 있네요. 이 혼란 속에서 당신만의 중심을 잡는 것이 중요합니다. 그러나 지금은 억지로 앞으로 나아가기보다 주변을 경계하고 멈춰 서야 할 때임을 명심하세요.",
        todayWarningAdvice: "소모적인 논쟁이 잦아들고 있습니다. 이 싸움의 승자가 누구인지보다, 우리가 무엇을 잃었는지 먼저 생각하세요. 이 흐름에서 무리한 행동은 큰 화를 부를 수 있으니, 모든 결정을 보류하고 철저히 관망하는 것이 현명합니다.",
    ...
    27: {
        ...
        todayWarningAdvice: "왕관의 무게가 당신을 짓누릅니다. 오늘의 승리가 내일의 독이 되지 않도록 겸손의 미덕을 챙기세요. 이 흐름에서 무리한 행동은 큰 화를 부를 수 있으니, 모든 결정을 보류하고 철저히 관망하는 것이 현명합니다.",
    ...
    28: {
        ...
        todayWarningAdvice: "버티는 것만이 능사는 아닙니다. 포위망이 좁혀오고 있는데 혼자만의 고집으로 상황을 악화시키고 있지는 않나요? 이 흐름에서 무리한 행동은 큰 화를 부를 수 있으니, 모든 결정을 보류하고 철저히 관망하는 것이 현명합니다.",
    ...
    29: {
        ...
        todayWarningAdvice: "속도가 통제를 벗어났습니다. 섣부른 움직임은 목적지가 아닌 엉뚱한 곳으로 당신을 데려다 놓을 것입니다. 이 흐름에서 무리한 행동은 큰 화를 부를 수 있으니, 모든 결정을 보류하고 철저히 관망하는 것이 현명합니다.",
    ...
    30: {
        todayAdvice: "목표를 코앞에 두고 마지막 고비가 찾아왔습니다. 조금만 더 인내하며 끝까지 방심하지 마세요. 그러나 지금은 억지로 앞으로 나아가기보다 주변을 경계하고 멈춰 서야 할 때임을 명심하세요.",
        todayWarningAdvice: "방어벽이 무너지고 있습니다. 상처가 깊어지기 전에 잠시 물러나 추스르는 것도 용기입니다. 이 흐름에서 무리한 행동은 큰 화를 부를 수 있으니, 모든 결정을 보류하고 철저히 관망하는 것이 현명합니다.",
    ...
    31: {
        ...
        todayWarningAdvice: "등 위의 짐을 내려놓을 때가 되었습니다. 책임이 아닌 집착으로 붙들고 있었던 것들을 기꺼이 놓아주세요. 이 흐름에서 무리한 행동은 큰 화를 부를 수 있으니, 모든 결정을 보류하고 철저히 관망하는 것이 현명합니다.",
    ...
    32: {
        ...
        todayWarningAdvice: "호기심이 과하면 독이 됩니다. 깊이 없는 흥미는 당신의 시간을 낭비하게 만들고 소중한 기회를 가릴 것입니다. 이 흐름에서 무리한 행동은 큰 화를 부를 수 있으니, 모든 결정을 보류하고 철저히 관망하는 것이 현명합니다.",
    ...
    33: {
        ...
        todayWarningAdvice: "말만 앞선 추진력은 주변을 지치게 합니다. 당신의 열정이 타인을 태워버리는 불꽃이 되지 않도록 다스리세요. 이 흐름에서 무리한 행동은 큰 화를 부를 수 있으니, 모든 결정을 보류하고 철저히 관망하는 것이 현명합니다.",
    ...
    34: {
        ...
        todayWarningAdvice: "자신감이 오만으로 변하고 있습니다. 타인의 목소리를 무시한 채 독주하는 것은 당신의 왕국을 위태롭게 할 뿐입니다. 이 흐름에서 무리한 행동은 큰 화를 부를 수 있으니, 모든 결정을 보류하고 철저히 관망하는 것이 현명합니다.",
    ...
    35: {
        ...
        todayWarningAdvice: "권위에 취해 현장을 잊고 있지는 않나요? 당신의 결단이 독단이 되는 순간, 쌓아온 신뢰는 한순간에 무너집니다. 이 흐름에서 무리한 행동은 큰 화를 부를 수 있으니, 모든 결정을 보류하고 철저히 관망하는 것이 현명합니다.",
    ...
    36: {
        ...
        todayWarningAdvice: "넘쳐흐르는 감정이 이성을 가리고 있습니다. 실체 없는 기대감에 젖어 현실의 문제를 외면하고 있지는 않나요? 이 흐름에서 무리한 행동은 큰 화를 부를 수 있으니, 모든 결정을 보류하고 철저히 관망하는 것이 현명합니다.",
    ...
    37: {
        ...
        todayWarningAdvice: "조화로운 관계에 금이 가고 있습니다. 서로의 차이를 인정하지 못한 채 자신만의 방식을 강요하고 있지는 않은지 살피세요. 이 흐름에서 무리한 행동은 큰 화를 부를 수 있으니, 모든 결정을 보류하고 철저히 관망하는 것이 현명합니다.",
    ...
    38: {
        ...
        todayWarningAdvice: "즐거움에 취해 본질을 잊고 있습니다. 겉치레뿐인 관계 속에서 당신의 진심이 소모되고 있음을 느껴보세요. 이 흐름에서 무리한 행동은 큰 화를 부를 수 있으니, 모든 결정을 보류하고 철저히 관망하는 것이 현명합니다.",
    ...
    39: {
        todayAdvice: "눈앞의 제안들이 무의미하게 느껴질 수 있습니다. 지금은 밖이 아닌 안을 들여다볼 때입니다. 다만 다행히도 전체적인 흐름은 당신의 편이니, 주의하며 추진한다면 승산이 있습니다.",
        todayWarningAdvice: "권태에서 벗어날 기회가 왔습니다. 스스로를 가둔 침묵의 방에서 나와 당신에게 내밀어진 새로운 손을 잡으세요. 이 흐름에서 무리한 행동은 큰 화를 부를 수 있으니, 모든 결정을 보류하고 철저히 관망하는 것이 현명합니다.",
    ...
    40: {
        ...
        todayWarningAdvice: "슬픔의 터널이 끝나가고 있습니다. 잃어버린 것에 대한 미련을 접고, 이제 당신 뒤에 여전히 서 있는 사람들을 돌아보세요. 이 흐름에서 무리한 행동은 큰 화를 부를 수 있으니, 모든 결정을 보류하고 철저히 관망하는 것이 현명합니다.",
    ...
    41: {
        ...
        todayWarningAdvice: "추억은 힘이 되기도 하지만, 당신을 과거에 묶어두는 족쇄가 되기도 합니다. 이제 기억 속에서 나와 오늘을 사세요. 이 흐름에서 무리한 행동은 큰 화를 부를 수 있으니, 모든 결정을 보류하고 철저히 관망하는 것이 현명합니다.",
    ...
    42: {
        ...
        todayWarningAdvice: "환상이 걷히고 차가운 현실이 드러납니다. 뜬구름 잡는 소리는 그만두고 당신이 책임질 수 있는 단 하나를 선택하세요. 이 흐름에서 무리한 행동은 큰 화를 부를 수 있으니, 모든 결정을 보류하고 철저히 관망하는 것이 현명합니다.",
    ...
    43: {
        ...
        todayWarningAdvice: "떠나야 할 때를 놓치고 제자리를 맴돌고 있습니다. 변화를 두려워하며 익숙한 공허함 속에 자신을 방치하고 있지는 않나요? 이 흐름에서 무리한 행동은 큰 화를 부를 수 있으니, 모든 결정을 보류하고 철저히 관망하는 것이 현명합니다.",
    ...
    45: {
        ...
        todayWarningAdvice: "완벽해 보이는 평화 속에 불만족이 자라납니다. 겉보기에만 화려한 행복이 아닌, 내면의 실질적인 유대를 점검할 시간입니다. 이 흐름에서 무리한 행동은 큰 화를 부를 수 있으니, 모든 결정을 보류하고 철저히 관망하는 것이 현명합니다.",
    ...
    46: {
        ...
        todayWarningAdvice: "감성이 이성을 삼키고 있습니다. 사소한 말에 상처받고 현실을 도피하려는 당신의 태도가 성장을 가로막고 있습니다. 이 흐름에서 무리한 행동은 큰 화를 부를 수 있으니, 모든 결정을 보류하고 철저히 관망하는 것이 현명합니다.",
    ...
    47: {
        ...
        todayWarningAdvice: "매력적인 제안 뒤에 숨은 의도를 파악하세요. 감언이설에 속아 당신의 소중한 가치를 헐값에 넘기고 있지는 않은가요? 이 흐름에서 무리한 행동은 큰 화를 부를 수 있으니, 모든 결정을 보류하고 철저히 관망하는 것이 현명합니다.",
    ...
    48: {
        ...
        todayWarningAdvice: "과도한 공감은 당신을 갉아먹습니다. 남의 감정을 짊어지느라 정작 당신 자신의 영혼이 피폐해지고 있음을 인지하세요. 이 흐름에서 무리한 행동은 큰 화를 부를 수 있으니, 모든 결정을 보류하고 철저히 관망하는 것이 현명합니다.",
    ...
    49: {
        ...
        todayWarningAdvice: "감정을 무기로 타인을 조종하려 하지 마세요. 겉으로만 평온을 가장한 채 속으로 칼을 갈고 있는 것은 당신을 망칠 뿐입니다. 이 흐름에서 무리한 행동은 큰 화를 부를 수 있으니, 모든 결정을 보류하고 철저히 관망하는 것이 현명합니다.",
    ...
    54: {
        todayAdvice: "이겼지만 곁에 아무도 남지 않았네요. 축하해 주는 이 없는 승리가 과연 당신이 원하던 결과인가요? 그러나 지금은 억지로 앞으로 나아가기보다 주변을 경계하고 멈춰 서야 할 때임을 명심하세요.",
        todayWarningAdvice: "승패의 의미가 사라집니다. 부당하게 얻은 결과는 반드시 당신의 명예를 갉아먹을 것입니다. 지금이라도 화해의 손을 내미세요. 하지만 이 위기를 반면교사로 삼아 주의를 기울여 나아간다면, 오히려 상황이 긍정적으로 반전될 수 있습니다.",
    ...
    55: {
        ...
        todayWarningAdvice: "배가 제자리에서 맴돕니다. 과거의 무게를 덜어내지 못하면 당신의 여정은 끝나지 않은 채 고통의 바다를 표류할 것입니다. 하지만 이 위기를 반면교사로 삼아 주의를 기울여 나아간다면, 오히려 상황이 긍정적으로 반전될 수 있습니다.",
    ...
    58: {
        todayAdvice: "밤은 깊고 생각은 꼬리에 꼬리를 뭅니다. 하지만 태양이 뜨면 당신을 괴롭히던 괴물들은 아침 이슬처럼 사라질 것입니다. 그러나 지금은 억지로 앞으로 나아가기보다 주변을 경계하고 멈춰 서야 할 때임을 명심하세요.",
    ...
    59: {
        todayAdvice: "바닥을 치는 힘든 상황이 마무리되는 시점입니다. 이제 더 나빠질 곳은 없으니 다시 일어날 준비를 하세요. 그러나 지금은 억지로 앞으로 나아가기보다 주변을 경계하고 멈춰 서야 할 때임을 명심하세요.",
        todayWarningAdvice: "고통의 끝에서 희망이 보입니다. 당신을 찌르던 칼들이 하나씩 거둬지고 있습니다. 이제 상처를 꿰매고 다시 숨을 쉬세요. 하지만 이 위기를 반면교사로 삼아 주의를 기울여 나아간다면, 오히려 상황이 긍정적으로 반전될 수 있습니다.",
    ...
    60: {
        todayAdvice: "주변 상황을 예리하게 관찰하고 정보를 수집하세요. 경계심을 늦추지 말고 다가올 소식을 기다리세요. 다만 다행히도 전체적인 흐름은 당신의 편이니, 주의하며 추진한다면 승산이 있습니다.",
    ...
    64: {
        ...
        todayWarningAdvice: "풍요의 씨앗이 썩어가고 있습니다. 기회는 왔으나 당신의 게으름이나 과도한 의심이 그 결실을 가로막고 있습니다. 이 흐름에서 무리한 행동은 큰 화를 부를 수 있으니, 모든 결정을 보류하고 철저히 관망하는 것이 현명합니다.",
    ...
    65: {
        ...
        todayWarningAdvice: "저글링 하던 공들이 하나둘 떨어지기 시작합니다. 욕심을 내려놓고 가장 중요한 것 하나에만 집중하지 않으면 모든 것을 잃게 됩니다. 이 흐름에서 무리한 행동은 큰 화를 부를 수 있으니, 모든 결정을 보류하고 철저히 관망하는 것이 현명합니다.",
    ...
    66: {
        ...
        todayWarningAdvice: "각자도생의 흐름입니다. 협력은 무너지고 서로의 공로를 시기하는 분위기가 당신의 성취를 방해하고 있습니다. 이 흐름에서 무리한 행동은 큰 화를 부를 수 있으니, 모든 결정을 보류하고 철저히 관망하는 것이 현명합니다.",
    ...
    67: {
        ...
        todayWarningAdvice: "움켜쥔 손안의 모래는 결국 빠져나갑니다. 소유에 대한 공포가 당신을 고립시키고 있습니다. 이제 손을 펴고 흐름을 받아들이세요. 이 흐름에서 무리한 행동은 큰 화를 부를 수 있으니, 모든 결정을 보류하고 철저히 관망하는 것이 현명합니다.",
    ...
    68: {
        todayAdvice: "현실적인 고난이나 외로움이 느껴질 수 있는 날입니다. 혼자 끙끙대기보다 손을 내미는 용기가 필요합니다. 그러나 지금은 억지로 앞으로 나아가기보다 주변을 경계하고 멈춰 서야 할 때임을 명심하세요.",
    ...
    69: {
        ...
        todayWarningAdvice: "베풂이 권력이 되지 않도록 하세요. 당신의 호의가 타인에게 굴욕이 되고 있지는 않은지, 혹은 생색내기에 그치고 있지는 않은지 돌아보세요. 이 흐름에서 무리한 행동은 큰 화를 부를 수 있으니, 모든 결정을 보류하고 철저히 관망하는 것이 현명합니다.",
    ...
    70: {
        ...
        todayWarningAdvice: "애쓴 보람이 보이지 않아 허탈함이 느껴집니다. 하지만 지금 포기하는 것은 지금까지의 공을 모두 버리는 일입니다. 묵묵히 마지막 거름을 주어야 합니다. 이 흐름에서 무리한 행동은 큰 화를 부를 수 있으니, 모든 결정을 보류하고 철저히 관망하는 것이 현명합니다.",
    ...
    72: {
        ...
        todayWarningAdvice: "화려한 겉모습 뒤에 공허함이 있습니다. 당신의 여유가 타인의 희생 위에 세워진 것은 아닌지, 혹은 혼자만의 성에 갇힌 고립은 아닌지 살펴보세요. 이 흐름에서 무리한 행동은 큰 화를 부를 수 있으니, 모든 결정을 보류하고 철저히 관망하는 것이 현명합니다.",
    ...
    74: {
        ...
        todayWarningAdvice: "현실성 없는 계획이 당신의 자산을 위협합니다. 공부만 하고 실행하지 않는 것은 지적 허영에 불과합니다. 이제는 실전의 감각을 익히세요. 이 흐름에서 무리한 행동은 큰 화를 부를 수 있으니, 모든 결정을 보류하고 철저히 관망하는 것이 현명합니다.",
    ...
    76: {
        ...
        todayWarningAdvice: "돌봄이 구속이 되고 있습니다. 당신의 친절이 상대를 숨 막히게 하고 있지는 않은지, 혹은 당신의 희생을 보상받으려 하지는 않는지 살피세요. 이 흐름에서 무리한 행동은 큰 화를 부를 수 있으니, 모든 결정을 보류하고 철저히 관망하는 것이 현명합니다.",
    ...
    77: {
        ...
        todayWarningAdvice: "물질적 성공이 당신의 눈을 가리고 있습니다. 숫자에만 집착하다 소중한 사람들의 진심을 잃고 있지는 않은가요? 진정한 부는 관계에서 나옵니다. 이 흐름에서 무리한 행동은 큰 화를 부를 수 있으니, 모든 결정을 보류하고 철저히 관망하는 것이 현명합니다.",
