                  ...
                  {cardsInfo.map((item, idx) => (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-4 mb-6 border-b border-amber-500/20 pb-4">
                        <div className={`w-4 h-4 rounded-full shadow-[0_0_10px_rgba(251,191,36,0.8)] ${item.role.startsWith('과거') ? 'bg-amber-700 border-2 border-amber-500' :
                      ...
                      <div className="space-y-6 md:space-y-8">
                        ...
                        {category !== 'today' && (() => {
                          ...
                          return (
                            <div className={`p-5 md:p-6 rounded-2xl relative border transition-all duration-500 ${isWarning
                              ...
                              <span className={`absolute -top-3 left-4 px-3 py-1 text-xs rounded-full tracking-widest border transition-colors ${isWarning
                              ...
                              <p className={`text-[15px] md:text-xl leading-loose tracking-wide break-keep mt-2 font-serif italic ${isWarning
                                ? 'text-rose-100/90'
